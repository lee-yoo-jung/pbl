    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // 그래프 크기 조절을 위해 SizedBox로 감싸고 높이를 지정합니다.
          SizedBox(
            height: 200,
            child: SfCartesianChart(
              // Key를 추가하여 데이터 변경 시 차트를 강제 재생성해 애니메이션 오류 방지
              key: ValueKey('GoalLineChartKey_$_endIndex'),
              ...
              series: <CartesianSeries<GoalRecord, String>> [
                ...
                LineSeries<GoalRecord, String>(
                    ...
                    // 애니메이션을 0으로 설정하여 Dispose 오류를 방지합니다.
                    animationDuration: 0,
