        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              ///사용자가 선택한 뱃지로 변경
              hasBadge?Image.asset('assets/images/badge3.png', width: 80, height: 80)
              : DottedBorder(color: Colors.grey,strokeWidth: 2,borderType: BorderType.Circle, dashPattern: [6,6],
                  child: Container(
                    width: 80,
                    height: 80,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ///사용자가 선택한 뱃지 글자로 변경
                    hasBadge? const Text('인기스타', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold))
                    : const Text(''),
                    const SizedBox(height: 8),
                    Row(
                      children: [
