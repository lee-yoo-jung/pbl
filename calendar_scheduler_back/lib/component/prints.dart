      ...
      child:ListView.builder(
          ...
          itemBuilder: (context,index){
            ...
            return GestureDetector(
              ...
              //목표(이벤트)출력
              child: Container(
                margin: EdgeInsets.symmetric(horizontal: 15.0, vertical: 17.0), //컨테이너의 테두리와 화면의 여백 설정
                          ...
                          return Row(
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child: Container(
                                  width: 300,
                                  padding: const EdgeInsets.symmetric(horizontal: 30, vertical: 5), // 안쪽 여백
                                  decoration: BoxDecoration(
                              ...
                              Transform.scale(    //크기 조정
                                ...
                                child: Checkbox(
                                  ...
                                  onChanged: (tf) {
                                    setState(() {
                                      checked[plan] = tf!;          // 값 변경 시 상태 업데이트
                                    });
                                  },
                                  //모서리 둥글게
