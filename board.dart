...
import 'package:pbl_back/tap/calender/board/ml.dart';
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      if (onlyCheckMode) {
                        ...
                        content = '${widget.nickname}님이 ${widget.todo.text} 계획을 완료했습니다.';
                        ...
                        // plan.isDone DB 업데이트
                        await supabase.from('plans').update({'is_done': true}).eq('id', widget.todo.id!);
                        setState(() {
                                  ...
                                  TextButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (mounted) {
                                        ...
                                        // **체크 화면 context에서 BoardPage로 pushReplacement**
