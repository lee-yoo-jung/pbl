...
import 'package:pbl/weather/weather_display.dart';
...
class MainCalendar extends StatefulWidget{
  ...
  final Map<DateTime, WeatherDay> weatherForecasts;
...
class _MainCalendarState extends State<MainCalendar> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedWeather = widget.weatherForecasts[selectedDateKey];
