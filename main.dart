  ...
  Widget build(BuildContext context) {
    return Scaffold( // 기본적인 Material 디자인 레이아웃 구조를 제공
      ...
      body: SingleChildScrollView(
        child: Padding(
          padding: const EdgeInsets.all(20),  // 모든 방향에 20의 여백
              ...
              children: [
                ...
                TextFormField(                // 텍스트 입력 필드
                  ...
                  decoration: const InputDecoration(     // 입력 필드의 디자인 설정
                    ...
                    prefixIcon: Icon(Icons.person),      // 필드 왼쪽에 사람 아이콘
                  ),
                ...
                TextFormField(
                  ...
                  obscureText: true, // 입력된 글자를 숨겨줌 (비밀번호용)
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      iconSize: 48,
                      onPressed: () => _onSocialLoginPressed('Naver'),
                      icon: Image.asset(
