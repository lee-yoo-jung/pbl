...
import 'package:pbl_back/tap/calender/board/models/message.dart';
import 'package:pbl_back/tap/calender/board/models/profile.dart';
import 'package:supabase_flutter/supabase_flutter.dart';
import 'package:pbl_back/tap/calender/calenderview.dart';
...
class _BoardPageState extends State<BoardPage> {
  ...
  Future<void> initBoard() async {
    ...
    try {
      ...
      debugPrint('리액션 로드 에러 (테이블 없음 등): $e');
    }
  ...
  Future<void> loadProfile(String userId) async {
    if (profiles[userId] != null) return;  //중복 방지
